...
$sql = "SELECT id_product, name_product, price, img_product, img_product2 FROM catolog_cd";
                                ...
                                <div class="manager__product-item">
                                    <a href="products.html" class="manager__product-thump">
                                        <div class="manager__product-img-container">
                                            <img src="./assets/img/shop_cd/<?php echo $row['img_product']; ?>" alt="" class="manager__product-img">
                                            <img src="./assets/img/shop_cd/<?php echo $row['img_product2']; ?>" alt="" class="manager__product-img manager__product-img-change">
                                        </div>
                                    </a>
                                </div>
